...
void CMainForm::OnInitialUpdate()
{
	...
	m_TabControl.InsertItem(2, L"Object");
	...
	m_ObjTool.Create(IDD_OBJECTTOOL, &m_TabControl );
	m_ObjTool.SetWindowPos(NULL, 0, 25, rc.Width() - 5, rc.Height() - 5, SWP_SHOWWINDOW);
	m_ObjTool.ShowWindow(SW_HIDE);
