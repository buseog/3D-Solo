...
HRESULT Engine::CShaderBuffer::Initialize(const _uint& iSizeX, const _uint& iSizeY)
{
	...
	pVertex[0].vPosition = MyVec4(-0.5f, -0.5f, 0.0f, 1.f);
	pVertex[0].vTexUV = MyVec2(0.f, 0.f);

	pVertex[1].vPosition = MyVec4((_float)iSizeX - 0.5f, -0.5f, 0.0f, 1.f);
	pVertex[1].vTexUV = MyVec2(1.f, 0.f);

	pVertex[2].vPosition = MyVec4((_float)iSizeX - 0.5f, (_float)iSizeY - 0.5f, 0.0f, 1.f);
	pVertex[2].vTexUV = MyVec2(1.f, 1.f);

	pVertex[3].vPosition = MyVec4(-0.5f, (_float)iSizeY - 0.5f, 0.0f, 1.f);
