	...
	if (((CMainFrame*)AfxGetMainWnd())->m_pMainForm->m_iToolType == 0)
	{
		...
		case 0:
			...
			case 0:
				...
				{
					m_pPick->m_pTransformCom->SetInfomation(Engine::CTransform::INFO_SCALE, &MyVec3(0.1f, 0.f, 0.f), 1);
				}
			...
			case 1:
				if (GetAsyncKeyState('Z') & 0x8000)
				{
					m_pPick->m_pTransformCom->SetInfomation(Engine::CTransform::INFO_SCALE, &MyVec3(0.f, 0.1f, 0.f), 1);
				}
				if (GetAsyncKeyState('X') & 0x8000)
				{
					m_pPick->m_pTransformCom->SetInfomation(Engine::CTransform::INFO_SCALE, &MyVec3(0.0f, -0.1f, 0.f), 1);
				}
				break;
			...
			case 2:
				if (GetAsyncKeyState('Z') & 0x8000)
				{
					m_pPick->m_pTransformCom->SetInfomation(Engine::CTransform::INFO_SCALE, &MyVec3(0.f, 0.f, 0.1f), 1);
				}
				if (GetAsyncKeyState('X') & 0x8000)
				{
					m_pPick->m_pTransformCom->SetInfomation(Engine::CTransform::INFO_SCALE, &MyVec3(0.f, 0.f, -0.1f), 1);
