...
public:
	...
	void SetCollision(_bool bTF);
	void SetBonus(const MyMat* pMat) { m_MatBonus = *pMat; }
	OBB* GetObbBox(void) { return &m_tOBB; }

public:
	virtual HRESULT Initialize(void);
	virtual void	Render(COLLTYPE eType, const MyMat* pMatWorld);
