...
HRESULT CMainApp::Ready_Setting(void)
{
	...
	if (FAILED(Engine::Get_FontMgr()->AddFont(m_pDevice, L"Font_Gulim", L"Gulim", 15, 15, FW_HEAVY)))
		return E_FAIL;
...
HRESULT CMainApp::Ready_Component( void )
{
	...
	// Material
	pComponent = Engine::CMaterial::Create(m_pDevice, D3DXCOLOR(1.f, 1.f, 1.f, 1.f), D3DXCOLOR(1.f, 1.f, 1.f, 1.f), D3DXCOLOR(1.f, 1.f, 1.f, 1.f), D3DXCOLOR(0.f, 0.f, 0.f, 0.f), 50.f);
	if (pComponent == NULL)
		return E_FAIL;
