...
HRESULT CMainApp::Ready_Component( void )
{
	...
	// Material
	pComponent = Engine::CMaterial::Create(m_pDevice, D3DXCOLOR(1.f, 1.f, 1.f, 1.f), D3DXCOLOR(0.4f, 0.4f, 0.4f, 1.f), D3DXCOLOR(1.f, 1.f, 1.f, 1.f), D3DXCOLOR(0.f, 0.f, 0.f, 0.f), 30.f);
	if (pComponent == NULL)
		return E_FAIL;
